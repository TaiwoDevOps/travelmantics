...
//        handling the image upload files
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == PICTURE_RESULT && resultCode == RESULT_OK){
            Uri imageUrl = Objects.requireNonNull(data).getData();
            StorageReference ref = FirebaseUtil.mStrorageRef.child(Objects.requireNonNull(Objects.requireNonNull(imageUrl).getLastPathSegment()));
